...
public class MessageConstants {
    ...
    public static final String NOT_NULL_PASSWORD = "비밀번호를 입력해주세요.";
    ...
    public static final String NICKNAME_PATTERN = "올바른 닉네임 형식을 입력해주세요.(한글, 영어, 숫자만 가능하며 공백없이 최대 10자까지 작성가능합니다.)";
    public static final String TITLE_PATTERN = "제목은 1 ~ 26자로 입력해주세요.";

    public static final String PASSWORD_MISMATCH = "비밀번호가 다릅니다.";
